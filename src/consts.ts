...
export const SITE_METADATA = {
    title: 'wtto\'s Blog',
    headerTitle: 'wtto\'s Blog',
    description: 'wtto\'s blog space',
    language: 'zh-cn',
    theme: 'system', // Options: system, light, dark, Does not work yet
    siteUrl: 'https://wtto00.github.io/wtto00/',
    siteRepo: 'https://github.com/wtto00/Blog',
    ...
    author: 'wtto00',
    email: 'wtto00@outlook.com',
    github: 'https://github.com/wtto00',
